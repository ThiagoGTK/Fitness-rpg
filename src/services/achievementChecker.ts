...
const ALL_ACHIEVEMENTS: Omit<Achievement, 'unlockedAt'>[] = [
  ...
  // ── Nutrição ──────────────────────────────────────────────────────────────
  { id: 'nutrition_first_meal',      title: 'Primeira Refeição',   description: 'Registre sua primeira refeição',                        icon: '🍽️' },
  { id: 'nutrition_meals_10',        title: 'Começando a Cuidar',  description: 'Registre 10 refeições',                                 icon: '🥗' },
  { id: 'nutrition_meals_50',        title: 'Nutrição Sólida',     description: 'Registre 50 refeições',                                 icon: '🥦' },
  { id: 'nutrition_streak_meals_7',  title: 'Semana Nutritiva',    description: 'Registre pelo menos uma refeição por 7 dias seguidos',  icon: '📆' },
  { id: 'nutrition_streak_meals_21', title: 'Hábito Formado',      description: 'Registre refeições por 21 dias seguidos',               icon: '🔁' },
  { id: 'nutrition_protein_goal_7',  title: 'Proteína em Foco',    description: 'Bata a meta de proteína por 7 dias seguidos',           icon: '🍗' },
  { id: 'nutrition_calorie_goal_7',  title: 'Calorias no Alvo',    description: 'Fique dentro da meta calórica por 7 dias seguidos',     icon: '🎯' },
  { id: 'nutrition_first_water',     title: 'Primeira Hidratação', description: 'Registre seu primeiro consumo de água',                 icon: '💧' },
  { id: 'nutrition_water_goal_7',    title: 'Mar Interno',         description: 'Bata a meta de hidratação por 7 dias seguidos',         icon: '🌊' },
  { id: 'nutrition_first_weight',    title: 'Primeira Pesagem',    description: 'Registre seu peso pela primeira vez',                   icon: '⚖️' },
  { id: 'nutrition_weight_10',       title: 'Monitoramento Ativo', description: 'Registre seu peso 10 vezes',                            icon: '📉' },
  { id: 'nutrition_goals_set',       title: 'Objetivos Definidos', description: 'Configure suas metas nutricionais',                     icon: '🏁' },
];
